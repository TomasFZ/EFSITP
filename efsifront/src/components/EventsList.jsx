...
function EventsList() {
  ...
  // Función para redirigir al componente de detalles del evento, pasando el evento en el estado
  const handleEventClick = (event) => {
    navigate(`/event/${event.id}`, { state: { eventDetails: event } }); // Pasar el evento a través del estado
  };
