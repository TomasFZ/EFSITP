...
function EventsList() {
  ...
  const token = localStorage.getItem('token');
  const userId = localStorage.getItem('userId'); // Asumiendo que guardas el ID del usuario al iniciar sesión
    ...
    <div className="events-container">
      ...
      <div className="create-event-form">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <input type="number" name="id_event_category" value={newEvent.id_event_category} onChange={handleInputChange} placeholder="ID Categoría del evento" required />
          <input type="number" name="id_event_location" value={newEvent.id_event_location} onChange={handleInputChange} placeholder="ID Ubicación del evento" required />
          <input type="datetime-local" name="start_date" value={newEvent.start_date} onChange={handleInputChange} required />
          <input type="number" name="duration_in_minutes" value={newEvent.duration_in_minutes} onChange={handleInputChange} placeholder="Duración (minutos)" required />
          <input type="number" name="price" value={newEvent.price} onChange={handleInputChange} placeholder="Precio" step="0.01" required />
          <label>
          ...
          <input type="number" name="max_assistance" value={newEvent.max_assistance} onChange={handleInputChange} placeholder="Asistencia máxima" required />
